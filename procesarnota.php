...
if(!$_POST){
    ...
    //sino boton modificar que esta en el archivo alumnoedit.view.php
        ...
        //capturamos el id alumnos a modificar
            ...
            $result = $conn->query("update alumnos set num_lista = '$numlista', nombres = '$nombres', apellidos = '$apellidos', genero = '$genero', carrera = '$id_carrera',id_grado = '$idgrado', id_seccion = '$idseccion' where id = " . $id_alumno);
            if (isset($result)) {
